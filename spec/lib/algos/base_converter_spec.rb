  ...
  describe "#value_from_decimal" do
    context "custom base 62" do
      it "generates a base62 based on a a given value" do
        base62_converter = Algos::BaseConverter.base62
    ...
    context "binary" do
      it "sets 0, 1 and 10 to their base 2 equivalents" do
        base2_converter = Algos::BaseConverter.binary
      ...
      it "converts unsigned short integer max to binary" do
        expect(Algos::BaseConverter.binary.value_from_decimal(65_535)).to(eq("1111111111111111"))
      end
    end
    ...
    context "hexadecimal" do
      ...
      it "converts 1 through 10 to their base16 equivalent" do
        base_converter = Algos::BaseConverter.hexadecimal
      ...
      it "converts unsigned short integer max to hex" do
        expect(Algos::BaseConverter.hexadecimal.value_from_decimal(65_535)).to(eq("FFFF"))
      end
    end
